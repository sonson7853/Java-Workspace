...
public class MainFrame extends javax.swing.JFrame{
	...
	public MainFrame() {
		...
		this.setBounds(200,200,300,200); //위치 크기설정
		...
		inputPanel.add(new JLabel("첫번째 정수는 :"));
		inputPanel.add(num1);
		inputPanel.add(new JLabel("두번째 정수는 : "));
		inputPanel.add(num2);
		...
		resultPanel.add(new JLabel("결과는 : "));
		...
		//minusBtn 클릭시 => 두개의 정수값을 가져온 후 뺄셈연산 결과를 result텍스트박스에 출력.
		...
		JLabel title = new JLabel("두 개의 정수를 입력하세요.",0);// 0 : 가운데 정렬 의미
