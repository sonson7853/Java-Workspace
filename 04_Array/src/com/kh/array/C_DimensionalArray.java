...
public class C_DimensionalArray {
	...
	public void method1() {
		 ...
		 * 안쪽 for문 => 열에 대해 지정(0열~4열) == (0열 ~ 열의크기-1) == (0열 ~ arr[].length-1)
		 * 
		 */
	...
	public void method4() {		
		 ...
		 * 
		 * 단, 행크기는 생략불가능, 반드시 지정해야함.
		 * 열 크기는 생략이가능. 각행의 열의 길이가 변경가능함.
		 */
		...
		//특정 인덱스로 접근하려했기때문에 NullPointerException에러발생
